...
export default function AuroraCallScreen({ navigation }) {
  ...
  const startConversation = async () => {
    if (!hasPermission) {
      Alert.alert('Permission Required', 'Please enable microphone access to call Aurora.');
      return;
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={[styles.header, { paddingTop: 20 + insets.top }]}>
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>Call Aurora</Text>
          <Text style={styles.headerSubtitle}>Voice conversation with your AI assistant</Text>
        </View>
      </View>
        ...
        {conversationHistory.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptyText}>
              Tap the microphone button below to start a voice conversation with Aurora about your diabetes management
            </Text>
            {userGlucoseContext && (
